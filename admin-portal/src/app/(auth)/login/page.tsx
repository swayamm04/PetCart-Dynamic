...
import { Eye, EyeOff, Lock, Mail, Loader2, Store } from "lucide-react"
...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        // Simulate API call
        setTimeout(() => {
            if (formData.email === "admin@petzy.com" && formData.password === "admin123") {
                // Set cookie manually for demo (middleware will read this)
                document.cookie = "admin_session=true; path=/"; // Session cookie (clears on browser close)
